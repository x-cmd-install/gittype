...
[![x-cmd/install — gittype Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/gittype.svg?lang=zh)](https://x-cmd.com/install/gittype)
...
- **Star**: 1,609 · **Fork**: 45 · **开放 issue**: 129 · **贡献者**: 8

## 累计统计

- **发布数**: 18 · **已合并 PR**: 365 · **开放 PR**: 1 · **已关闭 issue**: 114 · **开放 issue**: 15 · **提交数**: 1513
...
_数据快照: `data/card/260925.yml` · 2026-09-25T06:14:06Z._
